...
/**
 * @pClassName: AsyncProducerDemo
 * @author: pengbingjiang
 * @create: 2020/11/25 16:10
 * @description: TODO kafka简单异步发送Demo
 */
public class AsyncProducerDemo {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.101.206:9092");//kafka集群，broker-list
        ...
        // 2.调用send方法
        for (int i = 0; i < 100; i++) {
            producer.send(new ProducerRecord<String, String>("pbj-topic-1", Integer.toString(i), Integer.toString(i)), new Callback() {
                @Override
