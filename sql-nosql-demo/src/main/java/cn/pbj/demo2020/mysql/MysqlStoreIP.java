package cn.pbj.demo2020.mysql;

/**
 * @ClassName: MysqlStoreIP
 * @Author: pbj
 * @Date: 2020/5/30 20:23
 * @Description: TODO MySQL如何有效的存储IP地址  https://www.cnblogs.com/mmzs/p/12992560.html
 */
//Ipv4地址的转换
public class MysqlStoreIP {
    //将 IP地址 以字符串的形式保存在数据库
